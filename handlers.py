...
async def menu(msg: Message):  # Added async def
    await msg.answer(text.menu, reply_markup=kb.menu)  # Indentation adjusted

@router.callback_query(F.data == "generate_text")  # Adjusted indentation
